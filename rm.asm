...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 09 04 00 00       	call   443 <unlink>
  ...
  exit();
  4b:	e8 a3 03 00 00       	call   3f3 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  53:	68 dc 08 00 00       	push   $0x8dc
  58:	6a 02                	push   $0x2
  5a:	e8 01 05 00 00       	call   560 <printf>
      break;
  ...
  64:	52                   	push   %edx
  65:	52                   	push   %edx
  66:	68 c8 08 00 00       	push   $0x8c8
  6b:	6a 02                	push   $0x2
  6d:	e8 ee 04 00 00       	call   560 <printf>
    exit();
  72:	e8 7c 03 00 00       	call   3f3 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) 
{
  ...
  8b:	68 00 10 00 00       	push   $0x1000
  90:	e8 2b 07 00 00       	call   7c0 <malloc>
  if(stack == 0)
  95:	83 c4 10             	add    $0x10,%esp
  98:	85 c0                	test   %eax,%eax
  9a:	74 32                	je     ce <thread_create+0x4e>
  ...
  9e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a3:	05 00 10 00 00       	add    $0x1000,%eax
  a8:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
  ae:	0f 45 d8             	cmovne %eax,%ebx
  }

  // Call clone system call to create the thread
  pid = clone(start_routine, arg1, arg2, stack);
  b1:	53                   	push   %ebx
  b2:	ff 75 10             	pushl  0x10(%ebp)
  b5:	ff 75 0c             	pushl  0xc(%ebp)
  b8:	ff 75 08             	pushl  0x8(%ebp)
  bb:	e8 d3 03 00 00       	call   493 <clone>
  
  if(pid == 0) {
  c0:	83 c4 10             	add    $0x10,%esp
  c3:	85 c0                	test   %eax,%eax
  c5:	74 02                	je     c9 <thread_create+0x49>
    // Child thread - just return 0
    return 0;
  } else if(pid < 0) {
  c7:	78 0c                	js     d5 <thread_create+0x55>
    return -1;
  }
...
thread_join(void) 
{
  ...
  pid = join(&stack);
  fa:	8d 45 f4             	lea    -0xc(%ebp),%eax
  fd:	50                   	push   %eax
  fe:	e8 98 03 00 00       	call   49b <join>
  
  if(pid > 0) {
 103:	83 c4 10             	add    $0x10,%esp
 106:	85 c0                	test   %eax,%eax
 108:	7f 06                	jg     110 <thread_join+0x20>
 ...
 116:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 119:	e8 12 06 00 00       	call   730 <free>
...
lock_init(lock_t *lock) 
{
 ...
 137:	8b 45 08             	mov    0x8(%ebp),%eax
  lock->ticket = 0;
 13a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
 140:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
 147:	5d                   	pop    %ebp
 148:	c3                   	ret    
...
lock_release(lock_t *lock) 
{
 ...
 17a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 180:	5d                   	pop    %ebp
 181:	c3                   	ret    
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 fc 08 00 00 	movzbl 0x8fc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	eb 1a                	jmp    700 <printf+0x1a0>
          s = "(null)";
 6e6:	bb f5 08 00 00       	mov    $0x8f5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 735:	a1 64 0c 00 00       	mov    0xc64,%eax
{
 ...
 756:	73 10                	jae    768 <free+0x38>
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	a3 64 0c 00 00       	mov    %eax,0xc64
}
 787:	5e                   	pop    %esi
 788:	5f                   	pop    %edi
 789:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 7cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7d0:	8b 3d 64 0c 00 00    	mov    0xc64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 819:	8b 3d 64 0c 00 00    	mov    0xc64,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 64 0c 00 00       	mov    0xc64,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 64 0c 00 00       	mov    %eax,0xc64
}
 ...
 88e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 64 0c 00 00 68 	movl   $0xc68,0xc64
 897:	0c 00 00 
    base.s.size = 0;
 89a:	bf 68 0c 00 00       	mov    $0xc68,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 68 0c 00 00 68 	movl   $0xc68,0xc68
 8a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8ab:	c7 05 6c 0c 00 00 00 	movl   $0x0,0xc6c
 8b2:	00 00 00 
    if(p->s.size >= nunits){
