...
main(void)
{
  ...
  if(fork() > 0)
  15:	e8 81 03 00 00       	call   39b <fork>
  1a:	85 c0                	test   %eax,%eax
  1c:	7e 0d                	jle    2b <main+0x2b>
    sleep(5);  // Let child exit before parent.
  1e:	83 ec 0c             	sub    $0xc,%esp
  21:	6a 05                	push   $0x5
  23:	e8 0b 04 00 00       	call   433 <sleep>
  28:	83 c4 10             	add    $0x10,%esp
  exit();
  2b:	e8 73 03 00 00       	call   3a3 <exit>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) 
{
  ...
  3b:	68 00 10 00 00       	push   $0x1000
  40:	e8 2b 07 00 00       	call   770 <malloc>
  if(stack == 0)
  45:	83 c4 10             	add    $0x10,%esp
  48:	85 c0                	test   %eax,%eax
  4a:	74 32                	je     7e <thread_create+0x4e>
  ...
  53:	05 00 10 00 00       	add    $0x1000,%eax
  58:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
  5e:	0f 45 d8             	cmovne %eax,%ebx
  }

  // Call clone system call to create the thread
  pid = clone(start_routine, arg1, arg2, stack);
  61:	53                   	push   %ebx
  62:	ff 75 10             	pushl  0x10(%ebp)
  65:	ff 75 0c             	pushl  0xc(%ebp)
  68:	ff 75 08             	pushl  0x8(%ebp)
  6b:	e8 d3 03 00 00       	call   443 <clone>
  
  if(pid == 0) {
  70:	83 c4 10             	add    $0x10,%esp
  73:	85 c0                	test   %eax,%eax
  75:	74 02                	je     79 <thread_create+0x49>
    // Child thread - just return 0
    return 0;
  } else if(pid < 0) {
  77:	78 0c                	js     85 <thread_create+0x55>
    return -1;
  }
  ...
  79:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  7c:	c9                   	leave  
  7d:	c3                   	ret    
    return -1;
  7e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  83:	eb f4                	jmp    79 <thread_create+0x49>
    free(stack);
  85:	83 ec 0c             	sub    $0xc,%esp
  88:	53                   	push   %ebx
  89:	e8 52 06 00 00       	call   6e0 <free>
    return -1;
  8e:	83 c4 10             	add    $0x10,%esp
  91:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  96:	eb e1                	jmp    79 <thread_create+0x49>
  98:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  9f:	90                   	nop

000000a0 <thread_join>:
...
thread_join(void) 
{
  ...
  a7:	83 ec 34             	sub    $0x34,%esp
  void *stack;
  int pid;
  
  // Wait for a thread to exit
  pid = join(&stack);
  aa:	8d 45 f4             	lea    -0xc(%ebp),%eax
  ad:	50                   	push   %eax
  ae:	e8 98 03 00 00       	call   44b <join>
  
  if(pid > 0) {
  b3:	83 c4 10             	add    $0x10,%esp
  b6:	85 c0                	test   %eax,%eax
  b8:	7f 06                	jg     c0 <thread_join+0x20>
  ...
  c9:	e8 12 06 00 00       	call   6e0 <free>
...
lock_init(lock_t *lock) 
{
  ...
  lock->ticket = 0;
  ea:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
  f0:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
  f7:	5d                   	pop    %ebp
  f8:	c3                   	ret    
...
xchg(volatile uint *addr, uint newval)
{
 ...
 105:	b9 01 00 00 00       	mov    $0x1,%ecx
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 80 08 00 00 	movzbl 0x880(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb 78 08 00 00       	mov    $0x878,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e5:	a1 d8 0b 00 00       	mov    0xbd8,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 737:	5e                   	pop    %esi
 738:	5f                   	pop    %edi
 739:	5d                   	pop    %ebp
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 d8 0b 00 00       	mov    %eax,0xbd8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 77d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 780:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 ...
 83e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf dc 0b 00 00       	mov    $0xbdc,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 862:	00 00 00 
    if(p->s.size >= nunits){
