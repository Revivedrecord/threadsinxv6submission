...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 21 04 00 00       	call   45b <mkdir>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	eb 1a                	jmp    700 <printf+0x1a0>
          s = "(null)";
 6e6:	bb fb 08 00 00       	mov    $0x8fb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 735:	a1 6c 0c 00 00       	mov    0xc6c,%eax
{
 ...
 756:	73 10                	jae    768 <free+0x38>
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	a3 6c 0c 00 00       	mov    %eax,0xc6c
}
 787:	5e                   	pop    %esi
 788:	5f                   	pop    %edi
 789:	5d                   	pop    %ebp
 ...
 7a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7aa:	a3 6c 0c 00 00       	mov    %eax,0xc6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7d0:	8b 3d 6c 0c 00 00    	mov    0xc6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 819:	8b 3d 6c 0c 00 00    	mov    0xc6c,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 6c 0c 00 00       	mov    0xc6c,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 6c 0c 00 00       	mov    %eax,0xc6c
}
 ...
 88e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 6c 0c 00 00 70 	movl   $0xc70,0xc6c
 897:	0c 00 00 
    base.s.size = 0;
 89a:	bf 70 0c 00 00       	mov    $0xc70,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 70 0c 00 00 70 	movl   $0xc70,0xc70
 8a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8ab:	c7 05 74 0c 00 00 00 	movl   $0x0,0xc74
 8b2:	00 00 00 
    if(p->s.size >= nunits){
