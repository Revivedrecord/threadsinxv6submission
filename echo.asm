...
main(int argc, char *argv[])
{
  ...
  38:	68 c8 08 00 00       	push   $0x8c8
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	50                   	push   %eax
  41:	68 ca 08 00 00       	push   $0x8ca
  46:	6a 01                	push   $0x1
  ...
  57:	68 cf 08 00 00       	push   $0x8cf
  5c:	50                   	push   %eax
  5d:	68 ca 08 00 00       	push   $0x8ca
  62:	6a 01                	push   $0x1
  64:	e8 f7 04 00 00       	call   560 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  exit();
  6c:	e8 82 03 00 00       	call   3f3 <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	eb 1a                	jmp    700 <printf+0x1a0>
          s = "(null)";
 6e6:	bb d1 08 00 00       	mov    $0x8d1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 735:	a1 38 0c 00 00       	mov    0xc38,%eax
{
 ...
 756:	73 10                	jae    768 <free+0x38>
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	a3 38 0c 00 00       	mov    %eax,0xc38
}
 787:	5e                   	pop    %esi
 788:	5f                   	pop    %edi
 789:	5d                   	pop    %ebp
 ...
 7a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7aa:	a3 38 0c 00 00       	mov    %eax,0xc38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7d0:	8b 3d 38 0c 00 00    	mov    0xc38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 819:	8b 3d 38 0c 00 00    	mov    0xc38,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 38 0c 00 00       	mov    0xc38,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 38 0c 00 00       	mov    %eax,0xc38
}
 ...
 88e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 38 0c 00 00 3c 	movl   $0xc3c,0xc38
 897:	0c 00 00 
    base.s.size = 0;
 89a:	bf 3c 0c 00 00       	mov    $0xc3c,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 3c 0c 00 00 3c 	movl   $0xc3c,0xc3c
 8a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8ab:	c7 05 40 0c 00 00 00 	movl   $0x0,0xc40
 8b2:	00 00 00 
    if(p->s.size >= nunits){
